...
// KEY FIX in this version: the /journey endpoint no longer calls
// calculateStudentStatus() for history records. For GRADUAND students that
// function hits the terminal gate and returns weightedMean:"0.00", causing
// the projected WAA to show 0.00. Instead we read annualMeanMark and
// weightedContribution directly from the stored academicHistory array.
// For the current-year block, GRADUAND/GRADUATED students are excluded and
// their finalWeightedAverage is used directly.
