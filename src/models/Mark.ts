...
// The model now stores the RAW SCORES exactly as they appear in the KU scoresheet
// This ensures data integrity and supports future audit/re-calculation.
...
const schema = new Schema<IMark>({
 ...
 attempt: { type: String, enum: ["1st", "re-take", "supplementary"], default: "1st" },
...
schema.index(
{ student: 1, programUnit: 1, academicYear: 1 },
{ unique: true }
);
