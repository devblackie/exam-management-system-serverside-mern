...
const sendRecoveryEmail = async (to, token, name) => {
    const link = `${config_1.default.frontendUrl}/reset-password/${token}`;
    await transporter.sendMail({
        from: `"${config_1.default.appName} Security" <${config_1.default.emailUser}>`,
        to,
        subject: `Password Recovery — ${config_1.default.appName}`,
          ...
          <tr>
            <td style="padding:36px 32px 28px;">
              ...
              <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">
                ...
                <strong style="color:#111827;">${config_1.default.instName}</strong>.
              </p>
          ...
          <tr>
            <td style="padding:20px 32px; border-top:1px solid #e5e7eb; background:#f9fafb;">
               <p style="margin:0;font-size:11px;color:#9ca3af;text-align:center;">
                Protected by ${config_1.default.appName} Infrastructure · Audit log active
              </p>
            </td>
          </tr>
        </table>
